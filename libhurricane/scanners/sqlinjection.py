#!/usr/bin/python3
# -*- coding:utf-8 -*-
"""LibHurricane - библиотека для поиска данных, OSINT разведки, криптографии и нетворкинга
...
def is_vulnerable(response):
	...
	уязвима перед SQL-инъекцией из-за ее «ответа»"""
...
def scan_sql_injection(session, url):
	...
	for form in forms:
		...
		for c in "\"'":
			...
			if is_vulnerable(res):
				print("[+] SQL инъекция найдена; ссылка:", url)
				print("[+] Форма:")
				pprint(form_details)
				break
